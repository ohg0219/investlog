...
| archive | `refs/actions/archive.ref.md` | completed | `docs/archive/YYYY-MM/{feature}/` |
| cleanup | `refs/actions/cleanup.ref.md` | archived 존재 | 상태 정리 |
| commit | `refs/actions/commit.ref.md` | 변경사항 존재 | git commit |
